...
3. Install Backend Dependencies
    npm install
    npm install express mysql2 cors dotenv bcryptjs jsonwebtoken multer csv-parser nodemon sequelize
...
npm install
npm install axios react-router-dom bootstrap chart.js react-chartjs-2 recharts
